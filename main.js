...
const num_11 = Math.sqrt(121); // 11
const num_12 = Math.sqrt(9); // 3
const num_13 = Math.sqrt(20); // 4.47213595499958

// ------------- log() ----------------
// Функция log() возвращает натуральный логарифм числа:
const num_6 = Math.log(1); // 0
const num_7 = Math.log(10); // 2.302585092994046

// ------------- Тригонометрические функции  ----------------
// Целый ряд функций представляют тригонометрические функции: 
// sin() (вычисляет синус угла), cos() (вычисляет косинус угла), tan() (вычисляет тангенс угла).

const x_1 = Math.sin(90); // 0.8939966636005579
const y_1 = Math.cos(0); // 1
const z_1 = Math.tan(45); // 1.6197751905438615
